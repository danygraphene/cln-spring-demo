...
public class HomeController {
    ...
    public String home() {
        ...
        html.append("<!doctype html>\n")
            ...
            .append("        <div class=\"bg-slate-900 border border-slate-800 rounded-lg p-3\">\n")
            .append("          <div class=\"text-xs uppercase tracking-wide text-slate-400\">Alias</div>\n")
            .append("          <div class=\"text-sm font-semibold\">").append(safe(info.alias())).append("</div>\n")
            .append("        </div>\n")
            .append("        <div class=\"bg-slate-900 border border-slate-800 rounded-lg p-3\">\n")
            .append("          <div class=\"text-xs uppercase tracking-wide text-slate-400\">Network</div>\n")
            .append("          <div class=\"text-sm font-semibold\">").append(safe(info.network())).append("</div>\n")
            .append("        </div>\n")
            .append("        <div class=\"bg-slate-900 border border-slate-800 rounded-lg p-3\">\n")
            .append("          <div class=\"text-xs uppercase tracking-wide text-slate-400\">Block Height</div>\n")
            .append("          <div class=\"text-sm font-semibold\">").append(info.blockHeight()).append("</div>\n")
            .append("        </div>\n")
            .append("        <div class=\"bg-slate-900 border border-slate-800 rounded-lg p-3\">\n")
